        ...
        timeline =
        {
            TimeEvent(5 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/ro_bin/emote_idle")
            end),
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(0 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/ro_bin/mouth_open")
            end),
            TimeEvent(8 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/ro_bin/mouth_open", nil, .5)
            end),
        },
    },
...
CommonStates.AddWalkStates(states,
    {
        ...
        walktimeline =
        {
            ...
            TimeEvent(13 * FRAMES, function(inst)
                ...
                inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/foley/blubber_suit", nil, .3)
            end),
            TimeEvent(8 * FRAMES, function(inst)
                if inst.onwater then
                    inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/flap")
...
CommonStates.AddSleepStates(states,
    {
        ...
        {
            TimeEvent(0 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/hit") end)
        },

        sleeptimeline =
        {
            TimeEvent(10 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/sleep_out") end),
            TimeEvent(30 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/sleep_in") end),
            TimeEvent(40 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/sleep_out") end),
            TimeEvent(60 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/ro_bin/sleep_in") end),
